...
<main>
    ...
    <div id="crumbs" class="wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;">
        <ul>
            ...
            <li><a href="listClass.php" class="breadcrumb">Xem điểm cá nhân</a></li>
            <li><a href="listClass.php" class="breadcrumb">18T1</a></li>
            <li><a href="viewScores.php" class="breadcrumb">Ngô Kim Hoàng Minh</a></li>
        </ul>
    </div>
    <div class="page-body bs-danger">
        <div class="evaluate mt-2">
            ...
            <div class="list__class_appraise mt-1 wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;">
                ...
                <div class="evaluate__student-point-sum wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;" id="point_sum">
                    <table class=" table-bordered">
                        <tr class="font-weight-bold" style="background: floralwhite">
                            ...
                            <td class="align-middle">Giáo viên đánh giá</td>
                        </tr>
                            ...
                            <table class="table table-bordered border-primary d-table">
                                <thead class="text-center fw-bold">
                                    <tr>
                                        ...
                                        <th scope="col" class="align-middle">Giáo viên đánh giá</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="text-danger font-weight-bold">
                                        ...
                                        <td>20</td>
                                        <td>
                                            <p class="txt_rs_yttght_view"></p>
                                        </td>
                                        <td><p class="txt_rs_yttght_view"></p></td>
                                        <td><p class="txt_rs_yttght_view"></p></td>
                                    </tr>
                                    <tr class="text-muted">
                                        <th scope="row">1</th>
                                        ...
                                        <td>4</td>
                                        <td>
                                            <p class="txt_chuyencan_view">2</p>
                                        </td>
                                        <td><p class="txt_chuyencan_view">2</p></td>
                                        <td><p class="txt_chuyencan_view">3</p></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td>6</td>
                                        <td>
                                            <p class="txt_quychethi_view">6</p>
                                        </td>
                                        <td><p class="txt_quychethi_view">6</p></td>
                                        <td><p class="txt_quychethi_view">4</p></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                                        ...
                                        <td>2</td>
                                        <td>
                                            <p class="txt_vuonlen_view">2</p>
                                        </td>
                                        <td><p class="txt_vuonlen_view">2</p></td>
                                        <td><p class="txt_vuonlen_view">2</p></td>
                                    </tr>
                                    <tr class="text-muted">
                                        <th scope="row">5</th>
                                        ...
                                        <td>4</td>
                                        <td>
                                            <p class="txt_dtb_view">4</p>
                                        </td>
                                        <td><p class="txt_dtb_view">4</p></td>
                                        <td><p class="txt_dtb_view">4</p></td>
                                    </tr>
