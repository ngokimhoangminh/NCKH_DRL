...
<main>
    ...
    <div id="crumbs" class="wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;">
        <ul>
            ...
            <li><a href="#" class="breadcrumb">Danh sách lớp</a></li>
            <li><a href="#" class="breadcrumb">18T1</a></li>
            <li><a href="detailPoint.php" class="breadcrumb">Ngô Kim Hoàng Minh</a></li>
        </ul>
    </div>
                            ...
                            <table class="table table-bordered border-primary d-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td><p class="txt_chuyencan">2</p></td>
                                        <td><p class="txt_chuyencan">3</p></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td><p class="txt_quychethi">6</p></td>
                                        <td><p class="txt_quychethi">4</p></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                            ...
                            <table class="table table-bordered border-primary ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><p class="txt_qll">3</p></td>
                                        <td><input type="number" min="0" max="3" name="" value="0"
                                    ...
                                    <tr>
                                        ...
                                        <td><p class="txt_tcd">2</p></td>
                                        <td><input type="number" min="0" max="2" name="" value="0"
