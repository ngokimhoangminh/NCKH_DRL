...
<main>
    ...
    <div id="crumbs" class="wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;">
        <ul>
            <li><a href="teacher.html" class="breadcrumb">Trang chủ</a></li>
            <li><a href="#" class="breadcrumb">Đánh giá lại điểm</a></li>
            <li><a href="" class="breadcrumb">18T1</a></li>
            <li><a href="" class="breadcrumb">Ngô Kim Hoàng Minh</a></li>
        </ul>
    </div>
    <div class="page-body bs-danger">
        <div class="evaluate mt-2">
            <div class="evaluate__student-info d-flex wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;" >
            ...
            <div class="evaluate__student-point p-2">
                <div class="evaluate__student-point-sum wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;" id="point_sum">
                    <table class=" table-bordered">
                        <tr class="font-weight-bold" style="background: floralwhite">
                            ...
                            <td class="align-middle">Lớp đánh giá</td>
                        </tr>
                        <tr class="text-danger fw-bold">
                            ...
                            <td class="text-center" style="background: cornsilk;">
                                <p id="txt_total_Lop"></p>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="tabbed round mt-3 d-flex justify-content-center wow animate__fadeInUp" data-wow-duration="2s" style="visibility: visible;">
                    <ul class="nav nav-tabs">
                        ...
                        <div class="arrow"></div>
                        <li class="tabitem mr-0 " onclick="openCity(event,'v-pilss-mucV')"><a data-toggle="tab">Mục V<p id="total_mucV" class="text-center"></p></a>
                        </li>
                    </ul>
                </div>  
                            ...
                            <table class="table table-bordered border-primary d-table">
                                <thead class="text-center fw-bold">
                                    <tr>
                                        ...
                                        <th scope="col" class="align-middle">Lớp đánh giá</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="text-danger font-weight-bold">
                                        ...
                                        <td>20</td>
                                        <td>
                                            <p class="txt_rs_yttght_oficers"></p>
                                        </td>
                                        <td><p class="txt_rs_yttght_oficers"></p></td>
                                    </tr>
                                    <tr class="text-muted">
                                        <th scope="row">1</th>
                                        ...
                                        <td>4</td>
                                        <td>
                                            <p class="txt_chuyencan_oficers">2</p>
                                        </td>
                                        <td><p class="txt_chuyencan_oficers">2</p></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <p class="txt_clb_oficers">2</p>
                                        </td>
                                        <td class="border-bottom-0">
                                            <input type="number" min="0" max="2" name=""
                                                onclick="YThucThamGiaHocTap_Officers()" class="txt_clb_oficers" value="2">
                                        </td>
                                    </tr>
                                    <tr class="text-muted">
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td>6</td>
                                        <td>
                                            <p class="txt_quychethi_oficers">6</p>
                                        </td>
                                        <td><p class="txt_quychethi_oficers">4</p></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                                        <td>Được tập thể lớp công nhận có tinh thần vượt khó, phấn đấu vươn
                                            ...
                                            tập (2 điểm)</td>
                                        <td>2</td>
                                        <td><p class="txt_vuonlen_oficers">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" class="txt_vuonlen_oficers"
                                                value="2" onclick="YThucThamGiaHocTap_Officers()">
                                        </td>
                                    </tr>
                                    <tr class="text-muted">
                                        <th scope="row">5</th>
                                        ...
                                        <td>4</td>
                                        <td>
                                            <p class="txt_dtb_oficers">4</p>
                                        </td>
                                        <td><p class="txt_dtb_oficers">4</p></td>
                                    </tr>
                            ...
                            <table class="table table-bordered border-primary ">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td class="border-bottom-0"><p class="txt_shcd">10</p>
                                        <td class="border-bottom-0">
                                        </td>
                                    </tr>
                                    <tr class="text-muted">
                                        ...
                                        <td class="border-top-0 pt-0"><p class="txt_rlct">4</p></td>
                                        <td class="border-top-0 pt-0">
                                            <input type="number" min="0" max="6" name="" value="4" class="txt_rlct" onclick="YThucThamGiaHoatDongChinhTri_Officers()">
                                        </td>
                                        <td class="border-top-0 pt-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>2</td>
                                        <td><p class="txt_hdci">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" value="2" class="txt_hdci" onclick="YThucThamGiaHoatDongChinhTri_Officers()">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Có ý thức tham gia tuyên truyền, phòng chống tội phạm và các tệ
                                            ...
                                            điểm)</td>
                                        <td>2</td>
                                        <td><p class="txt_tnxh">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" value="2" class="txt_tnxh" onclick="YThucThamGiaHoatDongChinhTri_Officers()">
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered border-primary ">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-muted">
                                        ...
                                        <td class="border-bottom-0">
                                            <p class="txt_ctcd">4</p>
                                        </td>
                                        <td class="border-bottom-0"><p class="txt_ctcd">4</p></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>4</td>
                                        <td><p class="txt_hdxh">4</p></td>
                                        <td>
                                            <input type="number" min="0" max="4" name="" value="4"
                                                class="txt_hdxh" onclick="YThucCongDan_Officers()">
                                        </td>
                                        <td>
                                            <form enctype="multipart/form-data" method="POST">
                                                <input type="file" name="myfile" />
                                    ...
                                    <tr>
                                        ...
                                        <td>Có tinh thần chia sẻ, giúp đỡ người gặp khó khăn, hoạn nạn (2
                                            điểm)</td>
                                        <td>2</td>
                                        <td><p class="txt_gdnkk">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" value="2"
                                                class="txt_gdnkk" onclick="YThucCongDan_Officers()">
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Có ý thức, uy tín và hoàn thành tốt nhiệm vụ quản lý lớp, các tổ
                                            ...
                                            điểm)</td>
                                        <td>3</td>
                                        <td><p class="txt_qll">3</p></td>
                                        <td>
                                            <input type="number" min="0" max="3" name="" value="3"
                                                class="txt_qll" onclick="ThamGiaCongTacLop_Officers()">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>2</td>
                                        <td><p class="txt_tcd">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" value="2"
                                                class="txt_tcd" onclick="ThamGiaCongTacLop_Officers()">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>3</td>
                                        <td><p class="txt_tghdl">3</p></td>
                                        <td>
                                            <input type="number" min="0" max="3" name="" value="3"
                                                class="txt_tghdl" onclick="ThamGiaCongTacLop_Officers()">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>2</td>
                                        <td><p class="txt_dtt">2</p></td>
                                        <td>
                                            <input type="number" min="0" max="2" name="" value="2"
                                                class="txt_dtt" onclick="ThamGiaCongTacLop_Officers()">
                                        </td>
                                        <td>
                                            <form enctype="multipart/form-data" method="POST">
                                                <input type="file" name="myfile" />
